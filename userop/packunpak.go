...
func (uop *UserOperation) ToUserOpForApiV78(provider string) *UserOpForApiV78 {
	...
	return &UserOpForApiV78{
		...
		CallGasLimit:                  bigHex(uop.CallGasLimit),
		VerificationGasLimit:          bigHex(uop.VerificationGasLimit),
		PreVerificationGas:            bigHex(uop.PreVerificationGas),
		MaxFeePerGas:                  bigHex(uop.MaxFeePerGas),
		MaxPriorityFeePerGas:          bigHex(uop.MaxPriorityFeePerGas),
		Paymaster:                     JSAddressHex(uop.Paymaster, provider),
		PaymasterVerificationGasLimit: bigHex(uop.PaymasterVerificationGasLimit),
		PaymasterPostOpGasLimit:       bigHex(uop.PaymasterPostOpGasLimit),
